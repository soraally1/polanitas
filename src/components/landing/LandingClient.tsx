...
const FEATURES = [
  {
    ...
    desc: "Menjelajahi tren digital terpopuler secara langsung untuk menemukan kata kunci viral potensial.",
    tag: "Riset Tren Pasar",
    color: "#3B82F6",
  ...
  },
  {
    ...
    desc: "Merancang strategi konten kreatif dan draf naskah video siap pakai menggunakan formula viral teruji.",
    tag: "Strategi Konten",
    color: "#8B5CF6",
  ...
  },
  {
    Icon: Eye,
    title: "The Analyst",
    desc: "Mensintesis data riset dan skrip menjadi laporan kelayakan pasar lengkap dengan rencana aksi konkret.",
    tag: "Laporan Strategis",
    color: "#22C55E",
