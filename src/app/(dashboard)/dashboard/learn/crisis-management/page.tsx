...
- Bulan 4+: System reinforcement — audit and improvement`,
 ...
 {
 id: "crisis-drill",
 title: "Simulasi & Drill Krisis",
 concept: "Latihan Kesiapan Tim Sebelum Badai Datang",
 body: `Strategi manajemen krisis terbaik tidak akan berguna jika tim Anda panik saat krisis sesungguhnya terjadi. Oleh karena itu, **Simulasi & Drill Krisis** secara berkala sangat krusial. 

Tujuan simulasi ini adalah untuk melatih memori otot (muscle memory) tim Anda dalam mengambil keputusan di bawah tekanan.

**Cara Menjalankan Drill Krisis:**

**1. Skenario Tidak Terduga (Blind Scenario):** Buat skenario krisis tiruan (misal: kebocoran data pengguna, review buruk yang viral dari influencer top, atau kesalahan posting admin) tanpa memberi tahu tim sebelumnya.

**2. Batasan Waktu Ketat:** Berikan waktu yang sangat terbatas (misalnya 15-30 menit) kepada tim untuk melakukan asesmen awal, menyusun draf rilis, menentukan PIC respons, dan merancang mitigasi.

**3. Evaluasi Pasca-Drill (Debrief):** Setelah latihan selesai, lakukan evaluasi mendalam. Apakah alur komunikasi internal berjalan lancar? Apakah respons yang disiapkan sudah sesuai dengan framework E.A.R.? Di mana letak bottleneck keputusannya?`,
 insight:
 "Tim yang melakukan drill krisis minimal 2 kali setahun merespons krisis nyata 50% lebih cepat dengan tingkat kepanikan minimal.",
 challenge: `**DESAIN SKENARIO DRILL:** Rancang satu skenario krisis spesifik untuk bisnis atau brand Anda. Tuliskan 3 langkah pertama yang harus dilakukan oleh tim Anda dalam 15 menit pertama setelah krisis tersebut terdeteksi!`,
 quiz: {
 question:
 "Apa tujuan utama dari mengadakan drill krisis secara berkala bagi tim?",
 options: [
 "Menghukum anggota tim yang kurang teliti",
 "Melatih memori otot komunikasi dan pengambilan keputusan di bawah tekanan",
 "Mencari kesalahan sistem operasional",
 "Menghemat biaya public relations",
 ],
 correct: 1,
 explanation:
 "Tujuan utama drill krisis adalah melatih kesiapan mental dan alur koordinasi (muscle memory) sehingga ketika krisis sesungguhnya terjadi, tim dapat mengambil keputusan dengan tenang, terstruktur, dan cepat.",
 },
 },
];
