...
Kunci etis: nudge harus **transparan** dan **menguntungkan user**, bukan manipulatif.`,
 ...
 title: "Anchoring & Framing Effect",
 concept: "Mempengaruhi Persepsi Nilai Melalui Konteks",
 body: `Otak manusia tidak menilai harga atau nilai produk secara absolut, melainkan secara relatif berdasarkan informasi pertama yang diterima (**Anchoring**) dan cara informasi tersebut disajikan (**Framing**).

Bagaimana memanfaatkan kedua efek psikologis ini:

**1. Anchoring (Efek Jangkar):** Ketika melihat harga diskon dari Rp1.000.000 menjadi Rp299.000, otak menggunakan angka Rp1.000.000 sebagai jangkar (anchor). Harga Rp299.000 otomatis dipersepsikan sebagai penawaran yang sangat menguntungkan, meskipun nilai asli barang tersebut mungkin memang di kisaran itu.

**2. Loss Framing vs Gain Framing:** Otak manusia memiliki kecenderungan menghindari kerugian daripada mengejar keuntungan (loss aversion). Contoh framing:
- *Gain Frame:* "Hemat Rp100.000 jika berlangganan sekarang."
- *Loss Frame:* "Jangan biarkan Anda rugi Rp100.000 karena menunda berlangganan."
Secara umum, loss frame memicu konversi yang lebih kuat karena mengaktifkan amygdala (pusat rasa takut/rugi).`,
 insight:
 "Menyajikan harga core product berdampingan dengan anchor price yang lebih tinggi meningkatkan konversi hingga 35%.",
 challenge: `**UBAH FRAMING:** Ambil 1 baris copy penawaran produk Anda. Ubah copy tersebut dari format 'Gain Framing' menjadi 'Loss Framing'. Minta AI Lab menilai mana yang lebih persuasif!`,
 quiz: {
 question:
 "Mengapa loss framing ('Jangan kehilangan kesempatan hemat...') sering kali lebih efektif dibanding gain framing ('Dapatkan kesempatan hemat...')?",
 options: [
 "Karena manusia lebih takut kehilangan sesuatu (loss aversion) dibanding keinginan mendapatkan sesuatu dengan nilai yang sama",
 "Karena kata-kata negatif lebih mudah dibaca",
 "Karena gain framing tidak disukai oleh algoritma iklan",
 "Tidak ada perbedaan efektivitas antara keduanya",
 ],
 correct: 0,
 explanation:
 "Loss aversion is bias kognitif yang kuat di mana rasa sakit akibat kehilangan secara psikologis dua kali lebih kuat dibanding kesenangan mendapatkan sesuatu. Loss framing memanfaatkan bias ini.",
 },
 },
 {
 id: "sensory-marketing",
 title: "Sensory Marketing Digital",
 concept: "Mengaktifkan Indra Melalui Layar Kaca",
 body: `Meskipun audiens tidak bisa menyentuh, mencium, atau merasakan produk Anda melalui layar digital, Anda tetap bisa mengaktifkan sensasi sensorik mereka melalui **Sensory Marketing Digital** — teknik memicu asosiasi indra lewat rangsangan visual dan tekstual.

Cara mengaktifkan indra audiens secara digital:

**1. Visual Texture (Indra Peraba):** Gunakan video macro-shot yang menunjukkan tekstur detail produk, seperti lembutnya busa sabun, kasarnya serat kain, atau kelembapan embun di permukaan botol minuman dingin.

**2. Onomatopoeia (Indra Pendengaran):** Gunakan kata-kata tiruan bunyi untuk menciptakan sensasi auditori di pikiran pembaca (misalnya: *kriuk*, *cesss*, *plop*). Ini sangat efektif dalam copy produk makanan atau minuman.

**3. Synesthesia (Gabungan Indra):** Deskripsikan satu indra menggunakan indra lain (misalnya: "warna kuning yang hangat" atau "aroma kopi yang menenangkan jiwa").`,
 insight:
 "Iklan makanan yang menggunakan kata-kata deskriptif sensorik (seperti 'renyah' dan 'meleleh') menghasilkan 25% lebih banyak keinginan membeli dibanding iklan yang hanya menjelaskan bahan produk.",
 challenge: `**DESKRIPSI SENSORIK:** Pilih 1 produk fisik. Tulis paragraf deskripsi pendek yang memicu minimal 2 indra berbeda (visual + pendengaran/peraba) tanpa menyebutkan nama bahannya!`,
 quiz: {
 question:
 "Bagaimana cara memicu indra pendengaran audiens melalui copy tertulis di media sosial?",
 options: [
 "Menggunakan huruf kapital semua",
 "Menggunakan onomatopoeia (kata tiruan bunyi) seperti 'kriuk' untuk menggambarkan kerenyahan makanan",
 "Menulis dengan font berukuran besar",
 "Menulis deskripsi yang sangat panjang",
 ],
 correct: 1,
 explanation:
 "Onomatopoeia memicu stimulasi area auditori di otak pembaca secara otomatis, membuat mereka seolah-olah mendengar suara tersebut secara nyata di dalam kepala mereka.",
 },
 },
 {
 id: "neuromarketing-ethics",
 title: "Neuromarketing Ethics",
 concept: "Batas Etis Penggunaan Psikologi untuk Penjualan",
 body: `Pengetahuan tentang bagaimana otak bekerja memberikan kekuatan besar untuk mempengaruhi keputusan pembelian. Namun, kekuatan ini harus disertai dengan tanggung jawab moral melalui **Neuromarketing Ethics**.

Batas etis yang harus dijaga agar tidak tergelincir menjadi manipulasi jahat:

**1. Hindari Dark Patterns:** Jangan membuat manipulasi antarmuka yang mempersulit pengguna (misalnya: tombol 'Batal Langganan' yang disembunyikan atau ditulis dengan kontras sangat rendah sehingga tidak terlihat).

**2. Kejujuran Mutlak (No False Scarcity):** Jangan membuat hitung mundur palsu atau klaim stok palsu demi memicu FOMO. Urgency harus didasarkan pada data riil.

**3. Berorientasi pada Nilai Pengguna:** Pastikan produk Anda benar-benar memberikan nilai atau solusi yang dijanjikan. Psikologi persuasi harus digunakan untuk membantu user menemukan solusi terbaik, bukan menjebak mereka membeli barang sampah.`,
 insight:
 "Brand yang ketahuan menggunakan dark patterns mengalami penurunan reputasi online (NPS score) hingga 50% ketika kecurangan tersebut viral.",
 challenge: `**AUDIT ETIS:** Tinjau kembali strategi promosi Anda saat ini. Adakah elemen yang berpotensi menjadi dark pattern? Bagaimana Anda bisa mengubahnya agar tetap etis namun tetap konversif?`,
 quiz: {
 question:
 "Manakah contoh tindakan yang melanggar etika neuromarketing (borderline manipulatif)?",
 options: [
 "Menampilkan testimoni pelanggan nyata yang merasa puas",
 "Menyembunyikan biaya tambahan di halaman checkout akhir menggunakan trik visual (sneaking)",
 "Menjelaskan kegunaan produk dengan detail",
 "Memberikan garansi 30 hari uang kembali",
 ],
 correct: 1,
 explanation:
 "Trik visual 'sneaking' di mana biaya tambahan disembunyikan hingga detik terakhir checkout adalah bentuk dark pattern yang manipulatif dan melanggar transparansi etika pemasaran.",
 },
 },
];
