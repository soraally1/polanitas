...
**Minggu 7-8 — Defendable Position:** Ketika kompetitor mulai masuk, kamu sudah punya review, rating, and content authority. Switching cost bagi buyer menjadi tinggi.`,
 ...
 {
 id: "monitoring-whitespace",
 title: "Monitoring & Iterasi Whitespace",
 concept: "Sistem Pemantauan Rutin Peluang Pasar",
 body: `Menemukan satu whitespace tidaklah cukup karena tren pasar digital berputar sangat cepat. Whitespace yang hari ini sepi kompetitor bisa dalam 2-3 bulan berubah menjadi Red Ocean. Oleh karena itu, kita perlu membangun **Sistem Monitoring Rutin**.

Sistem monitoring rutin terdiri dari tiga pilar utama:

**1. Rutinitas Mingguan (Weekly Sweep):** Setiap hari Senin, lakukan audit pada keyword tracking list Anda di marketplace dashboard. Perhatikan jika ada kenaikan drastis pada search volume atau kemunculan seller baru.

**2. Rutinitas Bulanan (Monthly Deep Dive):** Lakukan audit kompetitor. Periksa produk baru yang mereka luncurkan dan review negatif pada produk terpopuler mereka. Review negatif adalah tambang emas untuk menemukan whitespace baru berupa fitur yang belum dipenuhi.

**3. Rutinitas Kuartalan (Quarterly Pivot):** Evaluasi portofolio produk/konten Anda. Jika suatu whitespace sudah terlalu padat kompetitor (Red Ocean), siapkan inovasi berikutnya atau alihkan fokus ke whitespace baru sebelum margin keuntungan Anda habis.`,
 insight:
 "Strategi defensif terbaik adalah terus bergerak secara proaktif dari satu whitespace ke whitespace berikutnya sebelum kompetitor sempat mendominasi.",
 challenge: `**BUAT JADWAL MONITORING:** Buat jadwal pemantauan mingguan dan bulanan versi Anda sendiri. Tuliskan 3 tools atau metric spesifik yang akan Anda periksa secara rutin!`,
 quiz: {
 question:
 "Apa tindakan terbaik yang harus diambil jika whitespace yang kita kuasai mulai dipadati kompetitor besar?",
 options: [
 "Menurunkan harga secara drastis untuk membunuh kompetitor",
 "Berhenti beriklan dan membiarkan traffic turun secara alami",
 "Mempersiapkan inovasi produk baru atau beralih ke whitespace berikutnya secara terencana",
 "Menuntut kompetitor karena meniru produk kita",
 ],
 correct: 2,
 explanation:
 "Ketika kompetitor besar masuk dengan resource tak terbatas, persaingan harga biasanya merusak margin. Strategi terbaik adalah memindahkan fokus ke whitespace berikutnya atau meningkatkan barrier dengan inovasi baru.",
 },
 },
];
...
export default function MarketplaceWhitespacePage() {
 ...
 if (sr && isCorrect && quizAnswer.correct) {
 ...
 borderRadius: "50%",
 background:
 sr && isCorrect && quizAnswer.correct
 ? "#16A34A"
 : sr && isSelected && !isCorrect
 ? "#DC2626"
 : "var(--color-surface-3)",
 display: "flex",
 alignItems: "center",
 ...
 fontWeight: 800,
 color:
 (sr && isCorrect && quizAnswer.correct) || (sr && isSelected)
 ? "#FFF"
